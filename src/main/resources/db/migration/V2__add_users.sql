INSERT INTO bank_service.user (id, name, date_of_birth, password) VALUES
                                                                      (1, 'Ivan Ivanov', '1980-01-01', 'password123'),
...
INSERT INTO bank_service.account (id, user_id, balance, initial_balance, max_balance) VALUES
                                                                                          (1, 1, 1000.00, 1000.00, false),
...
INSERT INTO bank_service.email_data (id, user_id, email) VALUES
                                                             (1, 1, 'ivan.ivanov@example.com'),
                                                             (2, 2, 'petr.petrov@example.com'),
                                                             (3, 3, 'sidor.sidorov@example.com'),
                                                             (4, 4, 'alex.alexeev@example.com'),
                                                             (5, 5, 'dmitry.dmitriev@example.com'),
                                                             (6, 6, 'sergey.sergeev@example.com'),
                                                             (7, 7, 'roman.romanov@example.com'),
                                                             (8, 8, 'vladimir.vladimirov@example.com'),
                                                             (9, 9, 'nikolay.nikolaev@example.com'),
                                                             (10, 10, 'mikhail.mikhailov@example.com');

INSERT INTO bank_service.phone_data (id, user_id, phone) VALUES
                                                             (1, 1, '+79001234501'),
                                                             (2, 2, '+79001234502'),
                                                             (3, 3, '+79001234503'),
                                                             (4, 4, '+79001234504'),
